...
class Car {
  ...
  drive(distance){
    ...
    if(distance <= milesUntilEmpty){
      ...
      this.odometer = this.odometer + milesUntilEmpty;
      this.tank = 0;
...
// const tay = new Lambdasian({name:'Taylor', age: 24, location: 'Lafayette'})
// console.log(tay.speak())
